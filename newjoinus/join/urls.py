...
urlpatterns = [
    ...
    path('share-to-instagram/', ImageShareView.as_view(), name='completed'),  # ImageShareView 추가
    #+
    # path('share-to-instagram/', InstagramRedirectTestView.as_view(), name='completed'),
